...
export default function LandAck(){
        return (
    <div> 
        <div className="row justify-content-center sbsBottomPadding">
            <div className="col-md-10"style={{ fontSize: 14 + "px" }}>
                <h5 class="font-a13 text-center">Land acknowledgment</h5>
                <p class="mb-2 text-left font-a33">SandPiper Solutions Inc. acknowledges the
